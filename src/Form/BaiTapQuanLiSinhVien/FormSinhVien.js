                    ...
                    <div className='row'>
                        <div className='col-6'>
                            <div className='form-group'>
                                <p>Mã Sinh Viên</p>
                                <input onChange={this.handleChangeInput} name='maSinhVien' type='text' className='form-control'></input>
                        ...
                        <div className='col-6'>
                            <div className='form-group'>
                                <p>Họ Tên</p>
                                <input onChange={this.handleChangeInput} name='tenSinhVien' type='text' className='form-control'></input>
                        ...
                        <div className='col-6'>
                            <div className='form-group'>
                                <p>Số Điện Thoại</p>
                                <input typeInput='phone' onChange={this.handleChangeInput} name='soDienThoai' type='text' className='form-control'></input>
                        ...
                        <div className='col-6'>
                            <div className='form-group'>
                                <p>Email</p>
                                <input typeInput='email' onChange={this.handleChangeInput} name='email' type='text' className='form-control'></input>
