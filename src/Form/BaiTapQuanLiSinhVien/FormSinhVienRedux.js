...
class FormSinhVienRedux extends Component {
    ...
    handleChangeInput = (event) => {
        ...
        const newValues = { ...this.props.values } // lưu lại các giá trị trc người dùng đã nhập
    ...
    handleSubmit = (event) => {
        ...
        for (let key in this.props.values) {
            if (this.props.values[key].trim() === '') {
                valid = false;
            }
        }

        for (let key in this.props.errors) {
            if (this.props.errors[key].trim() !== '') {
                valid = false;
            }
        }
                ...
                <div className="card-body">
                    <div className='row'>
                        ...
                        <div className='col-6'>
                            ...
                            <button onClick={ ()=> {}} type="button" className='btn btn-primary'>Cập Nhật Sinh Viên</button>
                        </div>
                    </div>
                </div>
            </form>
...
const mapStateToProps = (state) => ({ sinhVienRedux: state.stateDanhSachSinhVien.sinhVienRedux})
